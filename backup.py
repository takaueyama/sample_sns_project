...
# for shift_day in prepare_shift_days(start_date, end_date):
#     print(shift_day.day)
#     print(shift_day.day_point)
#     print(shift_day.night_point)
#     print(shift_day.day_people_count)
#     print(shift_day.night_people_count)
...
# for test_staff in test_staffs:
#     print(test_staff.name)
#     print(test_staff.point)
#     print(test_staff.max_night_shift_count)
#     print(test_staff.max_shift_count)

# テスト用のシフトの日付の範囲を用意
test_shift_days = prepare_shift_days(start_date, end_date)

# テスト用のシフトを作成
calulated_shift = calculate_shift(test_shift_days, test_staffs)

a ='かぶりなし'

for date in calulated_shift:
    print(date)
    print("日勤")
    for nikkin_staff in calulated_shift[date][0]:
        print(str(nikkin_staff.id) + ':' + nikkin_staff.last_name + nikkin_staff.first_name)
    print()
    print("夜勤")
    for yakin_staff in calulated_shift[date][1]:
        print(str(yakin_staff.id) + ':' + yakin_staff.last_name + yakin_staff.first_name)
        if yakin_staff in calulated_shift[date][0]:
            a = 'かぶってます！！'
    print(a)
    print()
    print()